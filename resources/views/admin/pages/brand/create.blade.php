                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p class="italic">
                                                    <small> The field labels marked with <span class="text-bold text-danger">*</span> are required input fields.</small>
                                                </p>
                                                ...
                                                <form id="submitForm" method="POST" action="">
                                                    ...
                                                    <div class="form-group">
                                                        <label>{{ trans('file.Name') }} <span class="text-bold text-danger">*</span></label>
                                                        <input type="text" name="name" required class="form-control" placeholder="Enter Brand name">
                                                    </div>
                                                    ...
                                                    <div class="custom-control custom-checkbox mb-3">
                                                        <input type="checkbox" class="custom-control-input" name="is_active" id="is_active_add" value="1" checked>
